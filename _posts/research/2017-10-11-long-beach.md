...
<div id="images">
  <div class="half">
    <img class="gunimage" border="0" src="{{ site.url }}/images/sh-noise-movie-high.gif">
    <p>this is text</p>
  </div>
  <div class="half">
    <img class="gunimage" border="0" src="{{ site.url }}/images/sh-master3-sym-movie-high35.gif">
